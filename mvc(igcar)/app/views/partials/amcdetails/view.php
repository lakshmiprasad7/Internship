...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Amcdetails</h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-amcInitiatorName">
                                        <th class="title"> Amcinitiatorname: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-amcValue">
                                        <th class="title"> Amcvalue: </th>
                                        <td class="value">
                                            <span  data-min="1" 
                                                data-step="0.1" 
                                    ...
                                    <tr  class="td-amcStartDate">
                                        <th class="title"> Amcstartdate: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-amcEndDate">
                                        <th class="title"> Amcenddate: </th>
                                        <td class="value">
                                            <span  data-flatpickr="{altFormat: 'Y-m-d', enableTime: false, minDate: '', maxDate: ''}" 
                                    ...
                                    <a class="dropdown-item export-link-btn" data-format="print" href="<?php print_link($export_print_link); ?>" target="_blank">
                                        ...
                                        <a class="dropdown-item export-link-btn" data-format="pdf" href="<?php print_link($export_pdf_link); ?>" target="_blank">
                                            ...
                                            <a class="dropdown-item export-link-btn" data-format="word" href="<?php print_link($export_word_link); ?>" target="_blank">
                                                ...
                                                <a class="btn btn-sm btn-info"  href="<?php print_link("amcdetails/edit/$rec_id"); ?>">
                                                    <i class="fa fa-edit"></i> Edit
                                                </a>
                                                <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("amcdetails/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
